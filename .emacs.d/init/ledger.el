...
(setq ledger-reports
	...
	("Balance Sheet L3" "%(binary) -f %(ledger-file) bal -c ^Asset ^Liability -X AUD --depth 3")
	...
	("Pending" "%(binary) -f %(ledger-file) reg --pending")
	("My Dining" "%(binary) -f %(ledger-file) -P reg ^Expense:Dining\\ Out")
	("My Payees" "%(binary) -f %(ledger-file) -P reg -S T")
